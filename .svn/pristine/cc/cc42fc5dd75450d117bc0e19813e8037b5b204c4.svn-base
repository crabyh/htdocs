    ...
    <div id="wrap">
      ...
      <div class="container">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="email" class="form-control" id="inputPassword" value="<?php echo $course_id ?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="email" class="form-control" id="inputPassword" value="<?php echo $row['cname'];?>">
          </div>
        </div>
        ...
        <div class="form-group" >
          ...
          <div class="col-sm-4">
            <input type="email" class="form-control" id="inputPassword" value="<?php echo $row['cdepartment'];?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="email" class="form-control" id="inputPassword" value="<?php echo $row['credit'];?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <textarea  type="email" class="form-control" rows="4" id="inputPassword"><?php echo $row['course_intro'];?></textarea>
          </div>
        </div>   

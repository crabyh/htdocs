        ...
        <div class="row clearfix">
          <div class="col-md-11 column">
            <dl>
              ...
              <dd>Yuhan Mao, working on job assignment, communication to other teams, front-end bootstrap development and php-part worker.</dd>
            </dl>

            <dl>
              <dt class="lead">StarCalm </dt>
              <dd>Junze Bao, working on JavaScript part, implementing part-refresh using AJAX which makes web work faster. Building some of the pages and debugging. Also known as a python user.</dd>
            </dl>

            <dl>
              <dt class="lead">HyukSoa </dt>
              <dd>Xuqian Zhang, working on PHP of security part, such as defending SQL injection, and system log. Also is responsible for managing files.</dd>
            </dl>

            <dl>
              <dt class="lead">Xenia Qian </dt>
              <dd>Xin Qian, working on front-end bootstrap development and php of database part, doing testing job afterwards.</dd>
            </dl>

            <dl>
              <dt class="lead">Lele </dt>
              <dd>Liao Li, working on the documenting jobs, also a tester afterwards.</dd>
            </dl>
